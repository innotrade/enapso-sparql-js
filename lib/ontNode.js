...
class OntNode {
	...
	getTriples() {
		return this.tripleStore.getTriples();
	}
	
	addTriple(args) {
		this.tripleStore.addTriple({ triple: args.triple });
	}

	addTriples(args) {
		this.tripleStore.addTriples({ triples: args.triples });
	}
